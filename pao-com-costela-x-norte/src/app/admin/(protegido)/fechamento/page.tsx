      ...
      {!turno || !resumo ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-4 text-center">
            <div className="border-2 border-admin-borda p-4 col-span-2">
          ...
          <div>
            ...
            <ul className="divide-y divide-admin-borda border-y-2 border-admin-borda text-sm">
              <li className="flex justify-between py-2"><span>Dinheiro</span><span className="preco">{formatarPreco(resumo.totalDinheiro)}</span></li>
              <li className="flex justify-between py-2"><span>Pix</span><span className="preco">{formatarPreco(resumo.totalPix)}</span></li>
              <li className="flex justify-between py-2"><span>Cartão</span><span className="preco">{formatarPreco(resumo.totalCartao)}</span></li>
            </ul>
          </div>
